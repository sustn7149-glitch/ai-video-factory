        ...
        <div className="min-h-screen bg-[#F5F5F5] flex flex-col text-[#111111]">
            ...
            <header className="h-16 bg-white border-b border-[#E5E5E5] flex items-center justify-between px-6 sticky top-0 z-20">
                ...
                <div className="flex items-center gap-2">
                    <h1 className="text-[18px] font-bold">AI 뉴스 Ep.{id}</h1>
                    <span className="px-2 py-0.5 bg-yellow-100 text-yellow-700 text-[11px] font-bold rounded">영상편집</span>
                </div>
            </header>

            <main className="flex-1 max-w-[1920px] mx-auto w-full p-6 flex gap-6 overflow-hidden h-[calc(100vh-64px)]">

                {/* Left Panel: Settings & Script */}
                <section className="flex-1 flex flex-col gap-6 overflow-y-auto pr-2 pb-20">
                ...
                <section className="w-[480px] flex flex-col gap-6 overflow-y-auto pb-20">
                    {/* Preview Card */}
                    <div className="bg-white rounded-xl border border-[#E5E5E5] p-6 shadow-sm flex flex-col items-center">
                        ...
                        {/* Phone Mockup */}
                        <div className={clsx(
                            "relative bg-[#111111] rounded-[40px] border-8 border-[#222222] shadow-2xl overflow-hidden flex flex-col transform transition-transform hover:scale-[1.02] duration-300",
                            aspectRatio === 'shorts' ? "w-[280px] h-[580px]" : "w-[480px] h-[270px] rounded-[20px]"
                        )}>
